...
class Game:
    ...
    def __init__(self, window, window_width, window_height):
        ...
        self.ball = Ball(self.window_width // 2, self.window_height // 2, 'smallBall.png')
    ...
    def _draw_divider(self):
        for i in range(80, self.window_height, self.window_height//20):
            if i % 2 == 1:
                continue
            pygame.draw.rect(
                self.window, self.WHITE, (self.window_width//2 - 10, i, 10, self.window_height//20))
